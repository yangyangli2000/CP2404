...
--
-- Host: localhost    Database: unienroldb
-- ------------------------------------------------------
...
CREATE TABLE `course` (
  ...
  `CrsUnits` varchar(45) DEFAULT NULL,
...
CREATE TABLE `enrollment` (
  ...
  `EnrGrade` decimal(5,1) DEFAULT NULL,
...
CREATE TABLE `faculty` (
  ...
  `FacSalary` varchar(45) DEFAULT NULL,
  `FacSupervisor` int DEFAULT NULL,
  `FacHireDate` date DEFAULT NULL,
  `FacZipCode` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`FacSSN`),
  KEY `faculty_supervise_fk_idx` (`FacSupervisor`),
  CONSTRAINT `faculty_supervise_fk` FOREIGN KEY (`FacSupervisor`) REFERENCES `faculty` (`FacSSN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `offering` (
  ...
  `OffLimit` varchar(45) DEFAULT NULL,
  `OffNumEnrolled` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`OfferNo`),
...
CREATE TABLE `student` (
  ...
  `StdGPA` decimal(5,1) DEFAULT NULL,
  `StdZip` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`StdSSN`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-04  0:13:09
