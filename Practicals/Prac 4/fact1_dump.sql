...
--
-- Host: localhost    Database: yangyangli_db
-- ------------------------------------------------------
...
CREATE TABLE `book` (
  ...
  `BOOK_SUNJECT` varchar(120) DEFAULT NULL,
  `PAT_ID` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`BOOK_NUM`),
  KEY `book_to_patron_idx` (`PAT_ID`),
  CONSTRAINT `book_to_patron` FOREIGN KEY (`PAT_ID`) REFERENCES `patron` (`PAT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `book` VALUES (5235,'Beginner\'s Guide to JAVA',2014,59.95,'Programming',NULL),(5236,'Database in the Cloud',2014,79.95,'Cloud',NULL),(5237,'Mastering the database environment',2015,89.95,'Database',NULL),(5239,'J++ in Mobile Apps',2015,49.95,'Programming',NULL),(5241,'JAVA First Steps',2015,49.95,'Programming',NULL),(5243,'DATABASES in Theory',2015,129.95,'Database',NULL),(5244,'Cloud-based Mobile Applications',2015,69.95,'Cloud',NULL),(5245,'The Golden Road to Platform independence',2016,119.95,'Middleware',NULL),(5247,'Shining Through the Cloud: Sun Programming',2016,109.95,'Programming',NULL),(5248,'What You Always Wanted to Know About Database, But Were Afraid to Ask',2016,49.95,'Database',NULL),(5250,'Reengineering the Middle Tier',2016,89.95,'Middleware',NULL),(5251,'Thoughts on Revitalizing Ruby',2016,59.95,'Programming',NULL),(5253,'Virtual Programming for Virtual Environments',2016,79.95,'Programming',NULL),(5254,'Coding Style for Maintenance',2017,49.95,'Programming',NULL);
...
CREATE TABLE `checkout` (
  ...
  KEY `checkout_to_patron_idx` (`PAT_ID`),
  KEY `checkout_to_book_idx` (`BOOK_NUM`),
  CONSTRAINT `checkout_to_book` FOREIGN KEY (`BOOK_NUM`) REFERENCES `book` (`BOOK_NUM`),
  CONSTRAINT `checkout_to_patron` FOREIGN KEY (`PAT_ID`) REFERENCES `patron` (`PAT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `checkout` VALUES (91001,5235,1165,'2017-03-31','2017-04-14','2017-04-09'),(91004,5237,1160,'2017-03-31','2017-04-14','2017-04-03'),(91005,5236,1202,'2017-03-31','2017-04-07','2017-04-08'),(91006,5235,1203,'2017-04-05','2017-04-12','2017-04-13'),(91007,5244,1174,'2017-04-05','2017-04-12','2017-04-08'),(91008,5248,1181,'2017-04-05','2017-04-12','2017-04-06'),(91010,5235,1161,'2017-04-05','2017-04-19','2017-04-05'),(91011,5236,1181,'2017-04-05','2017-04-12','2017-04-11'),(91014,5236,1204,'2017-04-11','2017-04-18','2017-04-19'),(91015,5237,1204,'2017-04-11','2017-04-18','2017-04-13'),(91016,5236,1183,'2017-04-13','2017-04-27','2017-04-14'),(91018,5236,1170,'2017-04-14','2017-04-28','2017-04-14'),(91020,5254,1185,'2017-04-16','2017-04-23','2017-04-23'),(91024,5235,1209,'2017-04-21','2017-04-28','2017-04-29'),(91026,5254,1161,'2017-04-21','2017-05-04','2017-04-26'),(91027,5243,1161,'2017-04-21','2017-05-04','2017-04-26'),(91028,5236,1183,'2017-04-22','2017-05-05','2017-04-30'),(91029,5244,1203,'2017-04-22','2017-04-29','2017-04-26'),(91033,5235,1174,'2017-04-23','2017-04-30','2017-04-23'),(91035,5248,1165,'2017-04-24','2017-05-07','2017-04-25'),(91036,5237,1202,'2017-04-24','2017-04-30','2017-04-28'),(91037,5235,1210,'2017-04-28','2017-05-04','2017-05-01'),(91040,5237,1228,'2017-04-28','2017-05-04','2017-05-05'),(91041,5236,1211,'2017-04-28','2017-05-04','2017-04-30'),(91042,5235,1220,'2017-04-29','2017-05-05','2017-05-05'),(91043,5244,1226,'2017-04-29','2017-05-05','2017-05-07'),(91044,5248,1219,'2017-04-30','2017-05-07','2017-05-08'),(91046,5235,1225,'2017-04-30','2017-05-07','2017-05-03'),(91047,5236,1218,'2017-04-30','2017-05-07','2017-05-07'),(91050,5236,1220,'2017-05-08','2017-05-15','2017-05-13'),(91051,5237,1222,'2017-05-08','2017-05-15','2017-05-15'),(91052,5236,1213,'2017-05-08','2017-05-15','2017-05-08'),(91054,5236,1221,'2017-05-09','2017-05-16','2017-05-11'),(91056,5254,1224,'2017-05-10','2017-05-17','2017-05-15'),(91060,5235,1209,'2017-05-15','2017-05-22','2017-05-18'),(91062,5254,1223,'2017-05-15','2017-05-22','2017-05-16'),(91063,5243,1223,'2017-05-15','2017-05-22','2017-05-20'),(91064,5236,1183,'2017-05-17','2017-05-31','2017-05-21'),(91065,5244,1210,'2017-05-17','2017-05-24','2017-05-17');
...
CREATE TABLE `writes` (
  ...
  KEY `writes_to_author_idx` (`AU_ID`),
  CONSTRAINT `writes_to_author` FOREIGN KEY (`AU_ID`) REFERENCES `author` (`AU_ID`),
  CONSTRAINT `writes_to_book` FOREIGN KEY (`BOOK_NUM`) REFERENCES `book` (`BOOK_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `writes` VALUES (5237,185),(5253,185),(5239,229),(5248,229),(5243,251),(5244,262),(5235,273),(5244,284),(5236,383),(5250,383),(5245,394),(5247,394),(5250,438),(5239,460),(5241,460),(5251,460),(5241,559),(5254,559),(5239,592);
...
-- Dump completed on 2020-04-01 12:45:55
