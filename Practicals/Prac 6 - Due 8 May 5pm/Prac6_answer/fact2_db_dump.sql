...
--
-- Host: localhost    Database: fact2_db
-- ------------------------------------------------------
...
CREATE TABLE `author` (
  ...
  `AU__BRITHEAR` decimal(4,0) DEFAULT NULL,
  PRIMARY KEY (`AU_ID`)
...
CREATE TABLE `writes` (
  `BOOK_NUM` decimal(10,0) DEFAULT NULL,
  `AU_ID` decimal(7,0) DEFAULT NULL,
  KEY `WRITES_BOOK_NUM_FK` (`BOOK_NUM`),
...
INSERT INTO `writes` VALUES (5235,273),(5236,383),(5237,185),(5238,603),(5239,229),(5239,460),(5239,592),(5240,218),(5241,460),(5241,559),(5242,581),(5243,251),(5244,262),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559),(5254,559);
...
-- Dump completed on 2020-05-18 22:38:11
